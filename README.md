...
Download the latest version from the [release](https://github.com/hwspeedy/arduino-mqtt/releases) section. Or even better use the builtin Library Manager in the Arduino IDE and search for "arduino-mqtt".
